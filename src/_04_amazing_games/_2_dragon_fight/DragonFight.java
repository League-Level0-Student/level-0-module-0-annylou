...
JOptionPane.showMessageDialog(null, "Defeat the dragon to take its treasure!", "Dragon Fighter", 0, dragon);
		...
		int playerAttack = 0;
		int dragonAttack = 0;
			// playerStrength to store the damage the player's attack will do - set it equal
			// to 0 for now.
			playerAttack = 0;
			// dragonStrength to store the damage the dragon's attack will do - set it equal
			// to 0 for now.
			dragonAttack = 0;
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
				String attack = JOptionPane.showInputDialog("attack with a kick or a yell");
			...
			// ASSESS THE DAMAGE
				...
				// 		dragon have left.
				JOptionPane.showMessageDialog(null, "the player's health is at " +playerHealth);
